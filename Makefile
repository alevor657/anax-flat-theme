...
#
# # target: upgrade-grid  	- Upgrade grid module.
# .PHONY: upgrade-grid
# upgrade-grid:
# 	@$(call HELPTEXT,$@)
#
# 	# Grid
# 	wget --quiet https://raw.githubusercontent.com/alevor657/design/master/example/grid/fluid/less/grid-flex.less -O $(LESS_MODULES)/grid-flex.less
# 	wget --quiet https://raw.githubusercontent.com/alevor657/design/master/example/grid/fluid/less/grid-float.less -O $(LESS_MODULES)/grid-float.less
...
# LESS and CSS
LESS 		 	= style.less light.less base.less color.less dark.less colorful.less typography.less deep.less colorp.less line.less black-structure.less widescreen.less light-gradient.less
LESS_MODULES	= modules/
LESS_OPTIONS 	= --strict-imports --include-path=$(LESS_MODULES)
CSSLINT_OPTIONS = --quiet
FONT_AWESOME 	= modules/font-awesome/fonts/
